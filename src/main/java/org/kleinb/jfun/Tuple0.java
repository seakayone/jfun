...
public record Tuple0() implements Tuple {
    ...
    public static <T1, T2, T3, T4, T5> Tuple5<T1, T2, T3, T4, T5> concat(Tuple5<T1, T2, T3, T4, T5> other) {
        return Tuple5.of(other._1(), other._2(), other._3(), other._4(), other._5());
    }

    public static <T1, T2, T3, T4, T5, T6> Tuple6<T1, T2, T3, T4, T5, T6> concat(Tuple6<T1, T2, T3, T4, T5, T6> other) {
        return Tuple6.of(other._1(), other._2(), other._3(), other._4(), other._5(), other._6());
    }

    public static <T1, T2, T3, T4, T5, T6, T7> Tuple7<T1, T2, T3, T4, T5, T6, T7> concat(Tuple7<T1, T2, T3, T4, T5, T6, T7> other) {
        return Tuple7.of(other._1(), other._2(), other._3(), other._4(), other._5(), other._6(), other._7());
    }

    public static <T1, T2, T3, T4, T5, T6, T7, T8> Tuple8<T1, T2, T3, T4, T5, T6, T7, T8> concat(Tuple8<T1, T2, T3, T4, T5, T6, T7, T8> other) {
        return Tuple8.of(other._1(), other._2(), other._3(), other._4(), other._5(), other._6(), other._7(), other._8());
    }
}
